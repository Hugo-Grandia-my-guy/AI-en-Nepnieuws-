    ...
    <div class="answers">
        ...
        <div class="quiz-question" id="q3">
            ...
            <div class="quiz-question" id="q4">
                ...
                <h3>Ronde 2: Welk huis is echt?</h3>
     ...
     <p>Wat betekent “machine learning”?</p>
        ...
        <div class="answers">
            <div class="radio-option">
                <input type="radio" name="Q4" id="Q6_A1" >
                <label for="Q2_A1">Machines leren zichzelf repareren</label>
            </div>

            <div class="radio-option">
                <input type="radio" name="Q4" id="Q6_A2" data-correct="true"> <!-- correct answer-->
                <label for="Q2_A2">computers leren patronen uit data kennen</label>
            </div>

            <div class="radio-option">
                <input type="radio" name="Q4" id="Q6_A3">
                <label for="Q2_A3">Computers bouwen machines</label>
            </div>

            <div class="radio-option">
                <input type="radio" name="Q4" id="Q6_A4">
        ...
        <p>Wat is data voor een AI-systeem?</p>
            ...
            <legend class="legend">Selecteer het juiste antwoord</legend>
                <div class="answers">
                <div class="radio-option">
                    <input type="radio" name="Q5" id="Q3_A1" data-correct="true"> <!-- correct answer -->
                    <label for="Q2_A1">Informatie waarmee AI kan leren en werken</label>
                </div>

                <div class="radio-option">
                    <input type="radio" name="Q5" id="Q3_A2">
                    <label for="Q2_A2">Een soort computerchip</label>
                </div>

                <div class="radio-option">
                    <input type="radio" name="Q5" id="Q3_A3">
                    <label for="Q2_A3">een programmeertaal</label>
                </div>

                <div class="radio-option">
                    <input type="radio" name="Q5" id="Q4_A4">
        ...
        <p>Wat is een belangrijk ethisch risico van generatieve AI?</p>
          ...
          <div class="answers">
              <div class="radio-option">
                  <input type="radio" name="Q6" id="Q5_A1" data-correct="true"><!-- correct answer -->
                  <label for="Q2_A1">Bias en discriminatie door trainingsdata</label>
              </div>

              <div class="radio-option">
                  <input type="radio" name="Q6" id="Q5_A2">
                  <label for="Q2_A2">Te veel schermhelderheid</label>
              </div>

              <div class="radio-option">
                  <input type="radio" name="Q6" id="Q5_A3">
                  <label for="Q2_A3">Langzame Wifi</label>
              </div>

              <div class="radio-option">
                  <input type="radio" name="Q6" id="Q5_A4">
                  <label for="Q2_A4">Te weinig opslagruimte</label>
              </div>
          </div>

<div class="bot_button">
    <a href="index.php?page=score" onclick="finishTest('text', 6)">
        Test afronden
    </a>
</div>
