...
<div class="answers">
    ...
    <div class="radio-option">
        <input type="radio" name="Q3" id="Q3_A2" checked> <!-- correct answer -->
...
<div>
    ...
    <div class="answers">
            ...
            <div class="radio-option">
                <input type="radio" name="Q4" id="Q4_A2" checked> <!-- correct answer -->
...
<div class="answers">
    <div class="radio-option">
        <input type="radio" name="Q5" id="Q5_A1" checked> 
